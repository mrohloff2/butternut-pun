...
Max Rohloff
4/17/2023
Purpose: Pull information from with YANG, print the information and edit a local dictionary
"""
...
#Gets the dictonary from our router
def getInts():
...
#Verifies that the IP and subnet are valid
def verifyIP(IPadd):
    a = 0
    check = 0
...
#Changes the IP in our dictionary
